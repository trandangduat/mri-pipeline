...
if [[ $START -le $stage ]]; then
    ...
    run "$stage" "15" "python3 $FASTSURFER_HOME/recon_surf/spherically_project.py -i ../surf/lh.inflated.nofix -o ../surf/lh.qsphere.nofix"
    ...
    run "$stage" "26" "python3 $FASTSURFER_HOME/recon_surf/spherically_project.py -i ../surf/rh.inflated.nofix -o ../surf/rh.qsphere.nofix"
