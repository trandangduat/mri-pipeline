const pillBase = 'inline-flex w-fit items-center rounded-full px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.08em]';
...
export const BUTTON = {
  ...
  primary: 'border-cursor-primary bg-cursor-primary text-white hover:border-cursor-primary-active hover:bg-cursor-primary-active',
  ink: 'border-cursor-ink bg-cursor-ink text-cursor-canvas hover:bg-cursor-ink',
  ghost: 'border-cursor-hairline bg-white text-cursor-ink hover:border-cursor-hairline-strong hover:bg-cursor-canvas-soft',
...
export function statusPillClasses(state) {
...
export function statusDotClasses(state) {
  const normalized = String(state || 'unknown').toLowerCase();
