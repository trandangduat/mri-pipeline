...
def build_tools_tab(parent: ttk.Frame, gui) -> None:
    ...
    gui.python_env_check_button = ttk.Button(py_buttons, text="Check Environment", command=gui._check_python_environment)
    gui.python_env_check_button.pack(side=tk.TOP, fill=tk.X, pady=(0, 4))
    gui.python_env_install_button = ttk.Button(py_buttons, text="Create / Update Packages", command=gui._install_python_requirements)
    gui.python_env_install_button.pack(side=tk.TOP, fill=tk.X)
    ...
    gui.tools_unselect_all_button.pack(side=tk.LEFT, padx=3)
    gui.tools_select_missing_button = ttk.Button(button_group, text="Select Missing", command=gui._select_missing_tool_images)
    gui.tools_select_missing_button.pack(side=tk.LEFT, padx=3)
    ...
    gui.tools_delete_button = ttk.Button(button_group, text="Delete", command=gui._delete_checked_tool_images, state=tk.DISABLED)
    gui.tools_delete_button.pack(side=tk.LEFT, padx=3)
    ...
    gui._sync_remote_connection_controls()
