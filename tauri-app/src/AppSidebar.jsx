        ...
        <SidebarHeader className="border-b border-cursor-hairline px-4 py-3 flex flex-row items-center justify-between gap-2">
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="flex flex-col min-w-0 group-data-[collapsible=icon]:hidden">
              <strong className="truncate text-sm font-semibold tracking-tight text-cursor-ink">
                NeuroFlow
              </strong>
          ...
          <SidebarMenu>
            ...
            <SidebarMenuItem>
              ...
              >
                ...
                <SidebarMenuBadge className="bg-cursor-hairline text-cursor-ink">
                  {jobs.length}
                </SidebarMenuBadge>
              </SidebarMenuButton>
              ...
              <SidebarMenuSub className="ml-4 mt-1 border-l border-cursor-hairline pl-2.5">
                {jobs.length === 0 ? (
                  ...
                  jobs.map((job) => {
                    ...
                    return (
                      <SidebarMenuSubItem key={job.job_id}>
                        <SidebarMenuSubButton
                          isActive={isSelected}
                          onClick={() => {
                            onSelectTab('jobs');
                        ...
                        >
                          <div className="flex items-center gap-2 min-w-0">
                            ...
                            <span className="truncate">{job.display_name || job.job_id}</span>
                          </div>
